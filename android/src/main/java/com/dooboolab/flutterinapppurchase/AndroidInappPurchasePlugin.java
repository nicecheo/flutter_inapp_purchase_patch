...
import com.dooboolab.flutterinapppurchase.DoobooUtils;
...
public class AndroidInappPurchasePlugin implements MethodCallHandler,  Application.ActivityLifecycleCallbacks {
  ...
  public void onMethodCall(final MethodCall call, final Result result) {
     ...
     */
      ...
      final String type = call.argument("type");
      List<Purchase> subs = billingClient.queryPurchases(type.equals("subs") ? BillingClient.SkuType.SUBS : BillingClient.SkuType.INAPP).getPurchasesList();
