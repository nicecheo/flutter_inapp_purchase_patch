...
public class DoobooUtils {
  ...
  private static com.dooboolab.flutterinapppurchase.DoobooUtils instance = new com.dooboolab.flutterinapppurchase.DoobooUtils();

  public static com.dooboolab.flutterinapppurchase.DoobooUtils getInstance() {
    return instance;
  }
